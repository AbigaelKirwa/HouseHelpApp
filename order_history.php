    ...
    <body>
        <div class="flex items-center justify-center mt-5">
            <h1 class="text-sky-700 font-bold text-3xl">Orders Page</h1>
        </div>
        <div class="grid grid-cols-3 gap-5 mt-10">
            ...
            <div class="px-20 py-10 bg-white rounded-lg shadow-md mx-auto text-center" style="width: 80%; border: 1px solid #ccc;">
    ...
    <div class="flex items-center justify-center mt-10">
        <button class="bg-black hover:bg-sky-700 text-white text-xl font-bold py-4 px-20 mb-10 rounded-full text-lg"><a href="home.php">Go to Home Page</a></button>
    </div>
    </body>
    </html>